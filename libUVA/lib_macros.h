...
*/
/*
	Miscellaneous macros for library and general usage.
*/

#define		LIB_MACROS_H_INCLUDED
...
#ifndef INTEGERIZE
# define INTEGERIZE(f)       ( ( (f)>= 0.) ? ((int)((f)+0.5)) : (-(int)(-(f)+0.5)) )
#endif

/* integral absolute value - (fabs from math.h should be used for floats) */
#define	IABS( x ) 	((x) >= 0 ? (x) : -(x) )

/* convert a boolean value to a string */

#define		YES_NO_STRING( s )	((s)?"Yes":"No")

#define		TRUE_FALSE_STRING( s )	((s)?"True":"False")
